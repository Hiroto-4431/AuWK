<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 w-1/5 drop-shadow-xl">
    ...
    <div class="mx-auto py-8">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:flex">
            <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')" class="block w-full">
        ...
        <!-- Navigation Links -->
        <div class="hidden space-x-8 sm:-my-px sm:flex">
            <x-nav-link :href="route('admin.user.index')" :active="request()->routeIs('admin.user.index') || request()->routeIs('admin.expired-user.index')" class="block w-full">
                <div  class="py-4 flex items-center w-full">
                    <img src="{{ asset("images/user.png") }}" class="ml-2 w-6 h-6 object-cover mr-4">
                    <span class="block">{{ __('Users') }}</span>
                </div>
            </x-nav-link>
        </div>
