<x-guest-layout>
    <form method="POST" action="{{ route('user.register') }}">
        ...
        <div class="mt-4">
            ...
            <select name="university" id="university" class="block w-full font-medium text-sm text-gray-700 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1" autofocus required>
        ...
        <div class="mt-4">
            ...
            <select name="birthday_year" id="birthday_year" class="inline font-medium text-sm text-gray-700 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1" required>
            ...
            <select name="birthday_month" id="birthday_month" class="inline font-medium text-sm text-gray-700 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                <option value="" disabled selected>---</option>
                @for ($i = 1; $i <= 12; $i++)
            ...
            <select name="birthday_date" id="birthday_date" class="inline font-medium text-sm text-gray-700 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                <option value="" disabled selected>---</option>
                @for ($i = 1; $i <= 31; $i++)
        ...
        <div class="mt-4">
            ...
            <select name="gender" id="gender" class="block w-full font-medium text-sm text-gray-700 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1" required>
                <option value="" disabled selected>選択してください</option>
